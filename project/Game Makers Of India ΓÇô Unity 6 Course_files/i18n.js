  ...
  const translations = {
    en: {
      text: {
        ...
        heroLine2: "Game Development",
        heroLine3: "for beginners",
        heroLang: "Taught in Hindi / Urdu",
        heroSub: "Build your first 2D game from scratch — one system at a time, explained in plain language for absolute beginners.",
        thumbChip: "Course Preview",
        heroBadge: "New Course",
    ...
    hi: {
      text: {
        ...
        heroLine2: "गेम डेवलपमेंट",
        heroLine3: "शुरुआती लोगों के लिए",
        heroLang: "हिंदी / उर्दू में सिखाया गया",
        heroSub: "शुरुआत से अपना पहला 2D गेम बनाएं — एक-एक सिस्टम करके, बिल्कुल शुरुआती लोगों के लिए आसान भाषा में समझाया गया।",
        thumbChip: "कोर्स प्रीव्यू",
        heroBadge: "नया कोर्स",
